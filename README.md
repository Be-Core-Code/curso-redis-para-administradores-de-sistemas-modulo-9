# Diapositivas del Curso Redis para Administradores de Sistemas - Módulo 9: Troubleshooting
...
```bash
> docker run --rm -p "8000:8000" becorecode/curso-redis-para-administradores-de-sistemas-modulo-9:latest
```
...
Puedes acceder a las diapositivas en `localhost:8009`. Haz los cambios que necesites en las diapositovas situadas en la carpeta
